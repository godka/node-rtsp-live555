...
fHaveWrittenFirstFrame(False) {
	live555response = handler;
	phwnd = live555responseData;
...
H264or5VideoStreamSink::~H264or5VideoStreamSink() {
}

void H264or5VideoStreamSink::afterGettingFrame(unsigned frameSize, unsigned numTruncatedBytes, struct timeval presentationTime) {
